...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nq-59tm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nq-59tm.containers.anotherwebservice.com/
...
```
git clone git@github.com:djfaizp/container-nq-59tm.git
```
